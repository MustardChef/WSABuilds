...
|- Windows™ 11: Build 22000.526 or higher.| - Windows™ 10: 22H2 10.0.19045.2311 or higher. <br /> <br /> <details><summary> **Unofficial support for Windows™ 10: 20H1 10.0.19041.264 or higher** </br>[***Click For More Information***]</br></summary> <br /> Future Releases, in this repo, after WSA Version 2301.40000.7.0 will have the change below implemented <br /> <br /> **Step 1:** You need to install [KB5014032](https://www.catalog.update.microsoft.com/Search.aspx?q=KB5014032) then install [KB5022282](https://www.catalog.update.microsoft.com/Search.aspx?q=KB5014032) to use WSA <br /> <br />  **Step 2:** MinVersion ---> TargetDeviceFamily node in AppxManifest.xml must be modified to "10.0.19041.264" before trying. <br /> **Join the Discord, if you need help on doing this!** </details>|
